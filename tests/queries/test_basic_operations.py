...
class TestBasicOperation(unittest.TestCase):
    ...
    def test_find_one(self):
        # object_id = self.Ticket.insert_one(**{'name': 'third', 'position': 3, 'config': {'param1': 'value'}})
    ...
    def test_find_and_update(self):
        ...
        data_with_prejection = self.Ticket.find_one_and_update(name='first', position__set=12, projection_fields=['position'])
